...
describe 'chef_test_5::default' do
  ...
  it 'install GreenShot' do
    expect(chef_run).to install_windows_package('GreenShot'). with(source: 'https://github.com/greenshot/greenshot/releases/download/Greenshot-RELEASE-1.2.9.104/Greenshot-INSTALLER-1.2.9.104-RELEASE.exe')
  end
